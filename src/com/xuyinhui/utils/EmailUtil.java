 ...
 * @author garyxuan
 * @see <a href=
 *      "http://www.oracle.com/technetwork/java/javamail/index.html">download
 *      JavaMail</a>
 * @see <a href=
 *      "http://www.oracle.com/technetwork/articles/java/index-135046.html">download
 *      JAF</a>
 *
 */
public class EmailUtil {
	 ...
	 *            消息体
	 * @param contentType
	 *            消息类型 {@link EmailUtil.ContentType}
	 */
	public static void sendEmail(String from, String to, String host, String password, String subject, String message,
	...
	public static void sendEmailWithSSL(String from, String to, String host, String password, String subject,
		...
		properties.put("mail.smtp.socketFactory.port", "465");// Linux下需要设置此项，Windows默认localhost为127.0.0.1
